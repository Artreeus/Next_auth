...
const ContactPage = () => {
  ...
  return (
    <div className="flex justify-center items-center mt-10 p-6 sm:p-10 min-h-screen relative overflow-hidden">
      {/* Floating particles container */}
      <div className="particle-container absolute inset-0 z-0"></div>
      
      {/* Glowing orb effect */}
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-gradient-to-tr from-purple-500/10 to-blue-500/5 blur-3xl z-0 animate-pulse-slow"></div>
      
      <Card className="w-full max-w-md z-10 shadow-[0_0_50px_rgba(128,0,255,0.15)] rounded-xl bg-glassmorphism relative overflow-hidden border-[1px] border-white/10">
        {/* Card header glow accent */}
        <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-purple-600 via-blue-400 to-purple-600 opacity-70"></div>
        ...
        <CardContent className="relative z-10">
          <div className="pt-5 pb-2 text-center">
            <h1 className="text-3xl font-bold mb-2 tracking-tight neon-text flex items-center justify-center gap-2">
          ...
          {submitted && (
            <div className="p-4 mb-6 bg-green-500/20 border border-green-500/30 backdrop-blur-sm rounded-lg text-green-400 flex items-center gap-2 text-sm font-medium animate-fade-in">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 mt-6">
            <div className="space-y-2">
              ...
              <div className={`relative ${focusedField === 'name' ? 'input-focused' : ''}`}>
                <Input
                  ...
                  required
                  className="w-full p-3 bg-white/5 border-white/10 rounded-lg focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all duration-300 pl-3"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className={`relative ${focusedField === 'message' ? 'input-focused' : ''}`}>
                <Textarea
                  ...
                  rows={5}
                  required
                  className="w-full p-3 bg-white/5 border-white/10 rounded-lg focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all duration-300 resize-none pl-3"
                />
              </div>
            </div>
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full py-5 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 font-semibold rounded-lg transition-all duration-300 relative overflow-hidden shadow-[0_4px_20px_rgba(125,137,255,0.3)]"
            >
